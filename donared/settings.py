"""
Django settings for donared project.
...
MAX_IMAGE_SIZE_MB = 2  # Maximum image size in MB
MAX_IMAGE_SIZE_BYTES = MAX_IMAGE_SIZE_MB * 1024 * 1024  # Convert to bytes
...
SECRET_KEY = os.environ.get('DONARED')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['donared.pythonanywhere.com', 'localhost', '127.0.0.1']
